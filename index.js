!(function (t, e) {
      ...
      switch (u) {
        ...
        case Ln.I64_STORE:
          ...
          M(r, st, it, 8),
            ...
            r.cfStack.finalizeTrapConditions(),
            3 === J && (J = 2),
            r.cfStack.addStatement(new ge(new At(ot), st, it, J)),
  ...
  var xn = 65536,
    ...
    Un = { MAGIC_NUMBER: 1836278016, VERSION_NUMBER: 13 },
    Ln = {
      UNREACHABLE: 0,
      NOP: 1,
      BLOCK: 2,
  ...
  (Bn.INT32_MIN = -2147483648),
    ...
    (Bn.i64_rem_u = function (t, e) {
      return t.toUnsigned().mod(e.toUnsigned()).toUnsigned().toSigned();
    }),
        ...
        switch (t.type) {
          ...
          case Cn.UNKNOWN:
            if (!this.isPolymorphic)
              throw new e(
                "pushing value of unknown type: " + JSON.stringify(t),
              );
            break;
          default:
